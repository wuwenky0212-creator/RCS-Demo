...
TAX_RULES: List[Dict[str, Any]] = [
    {
        ...
        "settlement_handling": "no_impact",
        "accounting_handling": "no_posting",
    },
    {
        "id": "TAX-IDR-010",
        "is_active": True,
        ...
        "bond_category": "国债",
        "bond_code": None,
        "related_transaction_id": "TRX-IDR-20260509-001",
        ...
        "created_by": "admin",
        "created_at": "2026-05-09",
        "settlement_handling": "impact",
        "accounting_handling": "posting",
    },
]
